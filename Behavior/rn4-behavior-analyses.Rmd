...
```{r open data}
path = '/Users/rosenasrawi/Documents/VU PhD/Projects/rn4:Mika - Vis-mot four items/Data/Lab data/logfiles/'

subjectIDs = c('s01', 's02', 's03', 's04', 's05', 's06', 's07', 's08', 's09', 's10', 's11', 's12', 's13', 's14', 's15', 's16', 's17', 's18', 's19', 's20', 's21', 's22', 's23', 's24', 's25')
sessions = c('a', 'b')
...
for (sID in subjectIDs){
  ...
  for (ses in sessions){
    filename = paste('rn4_', sID, ses, '.csv', sep = "")
