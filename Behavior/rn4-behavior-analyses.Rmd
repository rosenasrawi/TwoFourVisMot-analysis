...
```{r plot performance split}

# Change density plot line colors by groups
ggplot(data, aes(x=responseTimeClean, color = fastSlow, na.rm = TRUE)) +
...
color_1 = "#C7A0C7" # lilac
color_2 = "#D0A1E6" # lilac light 
color_3 = "#1CB4A5" # turquoise
color_4 = "#B1E6C9" # turquoise light
