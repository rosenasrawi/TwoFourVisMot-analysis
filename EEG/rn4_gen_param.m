...
function [param, eegfiles] = rn4_gen_param(this_subject)
    ...
    % Paths
    param.EEGpath           = '/Users/rosenasrawi/Documents/VU PhD/Projects/rn4:Mika - Vis-mot four items/Data/Lab data/eegdata/';
    param.path              = '/Users/rosenasrawi/Documents/VU PhD/Projects/rn4:Mika - Vis-mot four items/Data/';

    % Subjects and sessions
    param.subjectIDs    = {'s01', 's02', 's03', 's04', 's05'};

    eegfiles = {strcat('rn4_', param.subjectIDs{this_subject}, 'a', '.bdf'); 
                strcat('rn4_', param.subjectIDs{this_subject}, 'b', '.bdf')};
