...
for this_subject = subjects
    ...
    cfg.trialdef.eventvalue = param.triggers_resp; 
    cfg.trialdef.prestim    = param.T_resp_window(1); 
    cfg.trialdef.poststim   = param.T_resp_window(2); 
    ...
    save([param.path, 'Processed/Locked resp/epoched resp/' 'epoched_resp_s' num2str(this_subject)], 'data');
